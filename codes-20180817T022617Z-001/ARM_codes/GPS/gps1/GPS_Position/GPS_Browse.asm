...
SUB	SP, SP, #8
;GPS_Browse.c,98 :: 		GPIO_Digital_Output(&GPIOC_ODR,_GPIO_PINMASK_2);
MOVW	R1, #4
MOVW	R0, #lo_addr(GPIOC_ODR+0)
MOVT	R0, #hi_addr(GPIOC_ODR+0)
BL	_GPIO_Digital_Output+0
;GPS_Browse.c,99 :: 		GPIOC_ODR = 0x0000;
MOVS	R1, #0
MOVW	R0, #lo_addr(GPIOC_ODR+0)
MOVT	R0, #hi_addr(GPIOC_ODR+0)
STR	R1, [R0, #0]
;GPS_Browse.c,100 :: 		Delay_ms(100);
MOVW	R7, #9043
MOVT	R7, #8
NOP
NOP
...
NOP
NOP
;GPS_Browse.c,101 :: 		GPIOC_ODR = 0x0004;
MOVS	R1, #4
MOVW	R0, #lo_addr(GPIOC_ODR+0)
MOVT	R0, #hi_addr(GPIOC_ODR+0)
STR	R1, [R0, #0]
;GPS_Browse.c,103 :: 		UART3_Init_Advanced(9600, _UART_8_BIT_DATA, _UART_NOPARITY, _UART_ONE_STOPBIT, &_GPIO_MODULE_USART3_PD89);
...
ADD	SP, SP, #4
;GPS_Browse.c,104 :: 		Delay_ms(100);                // UART3 Init
MOVW	R7, #9043
MOVT	R7, #8
NOP
NOP
...
BL	_Display_Init+0
;GPS_Browse.c,108 :: 		while(1){
L_main10:
;GPS_Browse.c,109 :: 		for(i=0;i<768;i++){
MOVS	R0, #0
SXTH	R0, R0
STRH	R0, [SP, #0]
L_main12:
...
IT	GE
BGE	L_main13
;GPS_Browse.c,110 :: 		txt[i]=uart3_read();}
LDRSH	R1, [SP, #0]
MOVW	R0, #lo_addr(_txt+0)
MOVT	R0, #hi_addr(_txt+0)
ADDS	R0, R0, R1
...
;GPS_Browse.c,112 :: 		Display_Cursor(latitude, longitude, lat_str, long_Str,CL_BLACK);}
MOVW	R2, #0
MOVW	R0, #lo_addr(_longitude+0)
MOVT	R0, #hi_addr(_longitude+0)
LDRSH	R1, [R0, #0]
